      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="${pageContext.request.contextPath}/index">Home</a></span> <span class="mr-2"><a href="/searchAccomList">숙소</a></span> <span>숙소 정보</span></p>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/${accom.accomImg});"></div>
          				</div>
          				<div class="item">
		          				...
		          				<c:forEach items="${roomList}" var="rl">
		          					<div class="col-md-4">
						    			<div class="destination">
						    				<a href="searchRoomOne?roomNo=${rl.roomNo}" class="img img-2" style="background-image: url(images/${rl.roomMainImg});"></a>
						    				<div class="text p-3">
						    					<div class="d-flex">
						    						<div class="one">
							    					...
							    					<div class="two">
							    					<!--[이원희] 가격의 3자리수마다 콤마 출력 -->
							    						<span class="price per-price"><fmt:formatNumber value="${rl.roomPrice}" pattern="#,###"></fmt:formatNumber><br><small>대실/숙박</small></span>
						    						</div>
						    					</div>
