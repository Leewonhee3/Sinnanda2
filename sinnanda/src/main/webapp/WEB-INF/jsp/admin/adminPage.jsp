							...
							<div class="card position-relative">
								<div class="card-body">
									...
									<div class="container" style="margin-top: 20px; margin-bottom: 20px;">
										...
										<a href="noticeAdminList" style="float: right; ">목록 보기</a>
									</div>
								    	...
								    	<c:if test="${!empty noticeList}">
											...
											<c:forEach items="${noticeList}" var="notice">
												<tr>
													...
													<td>
														<a href="noticeAdminOne?noticeNo=${notice.noticeNo}">${notice.noticeTitle}</a>
													</td>
							...
							<div class="card position-relative">
								<div class="card-body">
									...
									<div class="container" style="margin-top: 20px; margin-bottom: 20px;">
										...
										<a href="memberQnaList" style="float: right; ">목록 보기</a>
									</div>
								    	...
								    	<c:if test="${!empty adminQnaList}">
											...
											<c:forEach items="${adminQnaList}" var="adminQna">
												<tr>
													...
													<td>
														<a href="memberQnaOne?qnaNo=${adminQna.qnaNo}">${adminQna.qnaTitle}</a>
													</td>
