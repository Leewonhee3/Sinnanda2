							...
							<div class="card position-relative">
								<div class="card-body">
									<span class="subheading" style="margin-left: 10px;">
										...
										<a href="adminAccomHostList?hostNo=${hostNo}">숙소 목록</a> > 
										숙소 상세
									</span>
											...
											<c:forEach items="${accom.rooms}" var="room">
												<tr>
													<td style="text-align: center;">
														<a href="adminRoomHostOne?roomNo=${room.roomNo}&hostNo=${hostNo}">${room.roomName}</a>
													</td>
									            ...
									            <div class="block-27">
													<ul>
														...
														<c:if test="${beginRow >= ROW_PER_PAGE}">
															<li><a href="adminAccomHostOne?accomNo=${accom.accomNo}&currentPage=${currentPage-1}">&lt;</a></li>
														</c:if>
														...
														<c:forEach var="i" begin="${pageNo}" end="${pageNo + 9}">
															...
															<c:if test="${not doneLoop}">
																<c:choose>
												    				...
												    				<c:otherwise>
																		<li><a href="adminAccomHostOne?accomNo=${accom.accomNo}&currentPage=${i}">${i}</a></li>	
																	</c:otherwise>		
																</c:choose>
