	...
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<!-- 본인의 게시글일 경우 수정, 삭제 -->
				...
				<div>
					<a class="btn btn-primary" href="noticeAdminList" style="float: left; margin-top: auto;">목록</a>				
					<a class="btn btn-primary" href="removeNotice?noticeNo=${notice.noticeNo}" style="float: right; margin-top: auto;">공지 삭제</a>
					<a class="btn btn-primary" href="modifyAdminNotice?noticeNo=${notice.noticeNo}" style="float: right; margin-top: auto;">공지 수정</a>
				</div>
